...
export const firestore = firebaseClientApp ? getFirestore(firebaseClientApp) : null;
export const firebaseStorage = firebaseClientApp ? getStorage(firebaseClientApp) : null;
